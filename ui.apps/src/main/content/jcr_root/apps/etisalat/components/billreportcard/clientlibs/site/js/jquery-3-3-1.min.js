!(function (e, t) {
  ...
  function H(e, t, r, i) {
    ...
    if (
      ...
      for (s = Te.map(w(o, "script"), A), u = s.length; f < p; f++)
        (l = o),
          f !== d &&
          ...
          (l = s[f]),
            Ze.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : n(l.textContent.replace(lt, ""), c, l));
    }
    return e;
  }
  function O(e, t, n) {
  ...
  function _() {
    bt &&
      (ae.hidden === !1 && e.requestAnimationFrame
  ...
  function X(e, t) {
    ...
    for (t = t ? 1 : 0; r < 4; r += 2 - t)
      (n = Ve[r]), (i["margin" + n] = i["padding" + n] = e);
      ...
      for (r in d)
        u ||
          (y
            ...
            : (y = Be.access(e, "fxshow", { display: l })),
          o && (y.hidden = !g),
          g && b([e], !0),
          p.done(function () {
      ...
      isPlainObject: function (e) {
        ...
        return (
          ...
          (!(t = se(e)) ||
            ...
            "function" == typeof n && ge.call(n) === ye))
        );
      },
      ...
      var i = n.length > 0,
        ...
        a = function (r, a, s, u, l) {
          ...
          if (((d += h), i && h !== d)) {
            ...
            if (r) {
              if (d > 0) for (; h--; ) g[h] || y[h] || (y[h] = Q.call(u));
              y = v(y);
            }
            K.apply(u, y),
        ...
        function (e) {
          ...
          return r !== H && 9 === r.nodeType && r.documentElement
            ? ((H = r),
              ...
              (R = []),
              (M = []),
              (T.qsa = ye.test(H.querySelectorAll)) &&
                (i(function (e) {
  ...
  (Te.fn.ready = function (e) {
    ...
    Te.extend({
      ...
      readyWait: 1,
      ready: function (e) {
        (e === !0 ? --Te.readyWait : Te.isReady) ||
          ((Te.isReady = !0),
          (e !== !0 && --Te.readyWait > 0) || Me.resolveWith(ae, [Te]));
      },
    }),
        ...
        for (
          n.handler && ((o = n), (n = o.handler), (i = o.selector)),
            ...
            (a = y.handle) ||
              (a = y.handle =
                function (t) {
                  return "undefined" != typeof Te &&
                    Te.event.triggered !== t.type
      ...
      if (y && (u = y.events)) {
        for (t = (t || "").match(Oe) || [""], l = t.length; l--; )
          if (
            ...
            a &&
              !p.length &&
              ((f.teardown && f.teardown.call(e, h, y.handle) !== !1) ||
                Te.removeEvent(e, d, y.handle),
              delete u[d]);
        ...
        for (
          ...
          for (
            ...
            (s.rnamespace && !s.rnamespace.test(o.namespace)) ||
              ...
              (s.data = o.data),
              (r = (
                (Te.event.special[o.origType] || {}).handle || o.handler
              ).apply(i.elem, u)),
              void 0 !== r &&
                (s.result = r) === !1 &&
    ...
    Te.each(
      {
        ...
        which: function (e) {
          var t = e.button;
          return null == e.which && rt.test(e.type)
            ? null != e.charCode
              ? e.charCode
              : e.keyCode
            : !e.which && void 0 !== t && it.test(e.type)
            ? 1 & t
              ? 1
              : 2 & t
              ? 3
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              ...
              (r = i[a]),
                (r.selected = Te.inArray(Te.valHooks.option.get(r), o) > -1) &&
                  (n = !0);
    ...
    Te.extend({
      ...
      ajax: function (t, n) {
          ...
          h.hasContent
            ...
            : ((d = h.url.slice(o.length)),
              h.data &&
                ...
                ((o += (Lt.test(o) ? "&" : "?") + h.data), delete h.data),
              h.cache === !1 &&
                ((o = o.replace(Wt, "$1")),
                (d = (Lt.test(o) ? "&" : "?") + "_=" + qt++ + d)),
              (h.url = o + d)),
        ...
        if (
          ...
          if (((C.readyState = 1), f && y.trigger("ajaxSend", [C, h]), c))
            return C;
          h.async &&
            h.timeout > 0 &&
  ...
  Te.ajaxSetup({
        ...
        if (this[0]) {
          ...
          if ("fixed" === Te.css(r, "position")) t = r.getBoundingClientRect();
            ...
            e &&
              ...
              1 === e.nodeType &&
              ((i = Te(e).offset()),
              (i.top += Te.css(e, "borderTopWidth", !0)),
    ...
    Te.each(["top", "left"], function (e, t) {
      Te.cssHooks[t] = M(ve.pixelPosition, function (e, n) {
        if (n)
          return (n = P(e, t)), ct.test(n) ? Te(e).position()[t] + "px" : n;
      });
    }),
  ...
  return (
    (Te.noConflict = function (t) {
      return (
        e.$ === Te && (e.$ = Zt), t && e.jQuery === Te && (e.jQuery = Kt), Te
      );
    }),
    t || (e.jQuery = e.$ = Te),
    Te
