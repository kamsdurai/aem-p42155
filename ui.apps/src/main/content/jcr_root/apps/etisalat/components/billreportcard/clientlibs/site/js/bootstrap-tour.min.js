!(function (t, e) {
  ...
  return (
    ...
    (e = (function () {
      ...
      return (
        (e.prototype.addSteps = function (t) {
          var e, o, n;
        ...
        (e.prototype.next = function () {
          var t;
          return (
            (t = this.hideStep(this._current, this._current + 1)),
        ...
        (e.prototype.goTo = function (t) {
          var e;
          return (
            (e = this.hideStep(this._current, t)),
        ...
        (e.prototype.end = function () {
          ...
          return (
            (e = (function (e) {
              return function (n) {
                if (
                  (t(o).off("click.tour-" + e._options.name),
                  t(o).off("keyup.tour-" + e._options.name),
                  t(window).off("resize.tour-" + e._options.name),
                  e._setState("end", "yes"),
                  (e._inited = !1),
                  (e._force = !1),
                  e._clearTimer(),
                  null != e._options.onEnd)
                )
                  return e._options.onEnd(e);
              };
            })(this)),
            (n = this.hideStep(this._current)),
            this._callOnPromiseDone(n, e)
          );
        }),
          ...
          return (
            ...
            t && t.duration
              ? ((this._paused = !1),
                ...
                null != t.onResume && this._duration !== t.duration
                  ? t.onResume(this, this._duration)
                  : void 0)
              : this
          );
        }),
        (e.prototype.hideStep = function (e, o) {
          ...
          if ((s = this.getStep(e)))
            return (
              this._clearTimer(),
              (i = this._makePromise(
                null != s.onHide ? s.onHide(this, e) : void 0
              )),
              (r = (function (n) {
                return function (r) {
                  var i, a;
                  if (
                    ...
                    s.reflex &&
                      t(s.reflexElement)
                        ...
                        .off(
                          "" +
                            n._reflexEvent(s.reflex) +
                            ".tour-" +
                            n._options.name
                        ),
                    s.backdrop &&
                      ((a = null != o && n.getStep(o)),
                      (a &&
                        a.backdrop &&
                        a.backdropElement === s.backdropElement) ||
                        n._hideBackdrop()),
                    null != s.onHidden)
                  )
                    return s.onHidden(n);
              ...
              (n = s.delay.hide || s.delay),
              "[object Number]" === {}.toString.call(n) && n > 0
                ? (this._debug(
                    "Wait " +
                      n +
                      " milliseconds to hide the step " +
                      (this._current + 1)
                  ),
                  window.setTimeout(
                    (function (t) {
        ...
        (e.prototype.showStep = function (t) {
          ...
          return this.ended()
            ...
            : ((a = this.getStep(t)),
              ...
              ((s = t < this._current),
              (n = this._makePromise(
                null != a.onShow ? a.onShow(this, t) : void 0
              )),
              this.setCurrentStep(t),
              (e = function () {
              ...
              !a.redirect ||
                !this._isRedirect(a.host, e, o.location) ||
                (this._redirect(a, t, e),
                this._isJustPathHashDifferent(a.host, e, o.location)))
                ? ((i = (function (e) {
                    return function (o) {
                      var n;
                      if (e._isOrphan(a)) {
                        if (a.orphan === !1)
                          return (
                            ...
                            void (s ? e._showPrevStep() : e._showNextStep())
                          );
                        e._debug(
                      ...
                      if (
                        (a.backdrop && e._showBackdrop(a),
                        (n = function () {
                          if (e.getCurrentStep() === t && !e.ended())
                            return (
                              null != a.element &&
                                a.backdrop &&
                                e._showOverlayElement(a, !0),
                              e._showPopover(a, t),
                              null != a.onShown && a.onShown(e),
                              e._debug(
                                "Step " +
                                  (e._current + 1) +
                                  " of " +
                                  e._options.steps.length
                              )
                            );
                        }),
                        a.autoscroll ? e._scrollIntoView(a, n) : n(),
                        a.duration)
                      )
                        return e.resume();
                    };
                  })(this)),
                  (r = a.delay.show || a.delay),
                  "[object Number]" === {}.toString.call(r) && r > 0
                    ? (this._debug(
                        "Wait " +
                          r +
                          " milliseconds to show the step " +
                          (this._current + 1)
                      ),
                      window.setTimeout(
                        (function (t) {
        ...
        (e.prototype.setCurrentStep = function (t) {
          return (
            null != t
              ? ((this._current = t), this._setState("current_step", t))
              : ((this._current = this._getState("current_step")),
                (this._current =
                  null === this._current ? null : parseInt(this._current, 10))),
            this
          );
        }),
        (e.prototype.redraw = function () {
          return this._showOverlayElement(
            this.getStep(this.getCurrentStep()).element,
            !0
          );
        }),
        (e.prototype._setState = function (t, e) {
          ...
          return (
            null == this._state && (this._state = {}), (this._state[t] = e)
          );
        }),
        (e.prototype._removeState = function (t) {
          var e;
          return this._options.storage
            ? ((e = "" + this._options.name + "_" + t),
              this._options.storage.removeItem(e),
              this._options.afterRemoveState(e))
            : null != this._state
        ...
        (e.prototype._getState = function (t) {
          ...
          return (
            this._options.storage
              ? ((e = "" + this._options.name + "_" + t),
                (o = this._options.storage.getItem(e)))
              : null != this._state && (o = this._state[t]),
        ...
        (e.prototype._debug = function (t) {
          if (this._options.debug)
            return window.console.log(
              "Bootstrap Tour '" + this._options.name + "' | " + t
            );
        }),
            ...
            !(
              ...
              !(
                ...
                ("[object String]" === {}.toString.call(t) &&
                  this._isHostDifferent(t, o))
              )
            ) ||
            ((n = [o.pathname, o.search, o.hash].join("")),
            null != e &&
              "" !== e &&
              (("[object RegExp]" === {}.toString.call(e) && !e.test(n)) ||
                ("[object String]" === {}.toString.call(e) &&
                  this._isPathDifferent(e, n))))
          );
        }),
        (e.prototype._isHostDifferent = function (t, e) {
          switch ({}.toString.call(t)) {
            ...
            case "[object String]":
              return (
                this._getProtocol(t) !== this._getProtocol(e.href) ||
                this._getHost(t) !== this._getHost(e.href)
              );
            default:
              return !0;
          }
        ...
        (e.prototype._isPathDifferent = function (t, e) {
          return (
            this._getPath(t) !== this._getPath(e) ||
            !this._equal(this._getQuery(t), this._getQuery(e)) ||
            !this._equal(this._getHash(t), this._getHash(e))
          );
        }),
        (e.prototype._isJustPathHashDifferent = function (t, e, o) {
          var n;
          return (
            (null == t || "" === t || !this._isHostDifferent(t, o)) &&
            ((n = [o.pathname, o.search, o.hash].join("")),
            "[object String]" === {}.toString.call(e) &&
              this._getPath(e) === this._getPath(n) &&
              this._equal(this._getQuery(e), this._getQuery(n)) &&
              !this._equal(this._getHash(e), this._getHash(n)))
          );
        }),
        (e.prototype._redirect = function (e, n, r) {
          var i;
          return t.isFunction(e.redirect)
            ? e.redirect.call(this, r)
            : ((i =
                "[object String]" === {}.toString.call(e.host)
                  ? "" + e.host + r
                  : r),
              this._debug("Redirect to " + i),
              this._getState("redirect_to") !== "" + n
                ? (this._setState("redirect_to", "" + n), (o.location.href = i))
                : (this._debug("Error redirection loop to " + r),
                  this._removeState("redirect_to"),
                  null != e.onRedirectError
                    ? e.onRedirectError(this)
                    : void 0));
        }),
        (e.prototype._isOrphan = function (e) {
          return (
            null == e.element ||
            !t(e.element).length ||
            (t(e.element).is(":hidden") &&
              "http://www.w3.org/2000/svg" !== t(e.element)[0].namespaceURI)
          );
        }),
        ...
        (e.prototype._showPopover = function (e, o) {
          ...
          if (
            ...
            i && ((e.element = "body"), (e.placement = "top")),
            (n = t(e.element)),
            n.addClass(
              "tour-" +
                this._options.name +
            ...
            (a = e.smartPlacement === !0 && e.placement.search(/auto/i) === -1),
            n
              .popover({
              ...
              .popover("show"),
            (r = n.data("bs.popover")
              ? n.data("bs.popover").tip()
              : n.data("popover").tip()),
            r.attr("id", e.id),
            this._focus(r, n, e.next < 0),
            this._reposition(r, e),
            i)
          )
            return this._center(r);
        }),
        (e.prototype._template = function (e, o) {
          ...
          return (
            (u = e.template),
            this._isOrphan(e) &&
              "[object Boolean]" !== {}.toString.call(e.orphan) &&
              (u = e.orphan),
            (a = t(t.isFunction(u) ? u(o, e) : u)),
            (n = a.find(".popover-navigation")),
            (i = n.find('[data-role="prev"]')),
            (r = n.find('[data-role="next"]')),
            ...
            e.reflex && a.addClass("tour-" + this._options.name + "-reflex"),
            e.prev < 0 &&
              i.addClass("disabled").prop("disabled", !0).prop("tabindex", -1),
            e.next < 0 &&
              r.addClass("disabled").prop("disabled", !0).prop("tabindex", -1),
            e.duration || s.remove(),
        ...
        (e.prototype._reposition = function (e, n) {
          ...
          if (
            ...
            (u = h.left),
            (p = h.top),
            (r = t(o).outerHeight() - h.top - e.outerHeight()),
            r < 0 && (h.top = h.top + r),
            ...
            h.left < 0 && (h.left = 0),
            e.offset(h),
            "bottom" === n.placement || "top" === n.placement)
          ) {
            if (u !== h.left)
              return this._replaceArrow(e, 2 * (h.left - u), a, "left");
          } else if (p !== h.top)
            return this._replaceArrow(e, 2 * (h.top - p), i, "top");
        }),
        (e.prototype._center = function (e) {
          return e.css(
            "top",
            t(window).outerHeight() / 2 - e.outerHeight() / 2
          );
        }),
              ...
              .on(
                ...
                function (o) {
                  ...
                  return (
                    ...
                    (n = t(this)),
                    n.text(
                      e._paused ? n.data("pause-text") : n.data("resume-text")
                    ),
                ...
                return function (e) {
                  if (e.which)
                    switch (e.which) {
                      case 39:
                        return (
                          e.preventDefault(), t._isLast() ? t.next() : t.end()
                        );
                      case 37:
                        if ((e.preventDefault(), t._current > 0))
                          return t.prev();
                    }
                };
              })(this)
        ...
        (e.prototype._showBackdrop = function (e) {
          if (!this.backdrop.backgroundShown)
            return (
              (this.backdrop = t("<div>", { class: "tour-backdrop" })),
              (this.backdrop.backgroundShown = !0),
              t(e.backdropContainer).append(this.backdrop)
            );
        }),
        ...
        (e.prototype._hideBackground = function () {
          if (this.backdrop && this.backdrop.remove)
            return (
              ...
              (this.backdrop.backgroundShown = !1)
            );
        }),
        (e.prototype._showOverlayElement = function (e, o) {
          ...
          if (
            ((r = t(e.element)),
            (n = t(e.backdropElement)),
            r && 0 !== r.length && (!this.backdrop.overlayElementShown || o))
          )
            return (
              this.backdrop.overlayElementShown ||
                ((this.backdrop.$element = n.addClass("tour-step-backdrop")),
                (this.backdrop.$background = t("<div>", {
                  class: "tour-step-background",
                })),
                this.backdrop.$background.appendTo(e.backdropContainer),
              ...
              e.backdropPadding &&
                (i = this._applyBackdropPadding(e.backdropPadding, i)),
        ...
        (e.prototype._hideOverlayElement = function () {
          if (this.backdrop.overlayElementShown)
            return (
              ...
              (this.backdrop.overlayElementShown = !1)
            );
        }),
        ...
        (e.prototype._getParams = function (t, e) {
          ...
          for (n = n[1].split("&"), r = {}, i = 0, s = n.length; i < s; i++)
            (o = n[i]), (o = o.split("=")), (r[o[0]] = o[1] || "");
          return r;
        }),
        (e.prototype._equal = function (t, e) {
          ...
          if (
            ...
            if (
              ...
              return !1;
            for (o in t) if (((i = t[o]), !this._equal(e[o], i))) return !1;
            return !0;
          }
          if (
