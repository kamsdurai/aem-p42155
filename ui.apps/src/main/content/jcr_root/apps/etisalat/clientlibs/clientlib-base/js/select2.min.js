      ...
      u.define('select2/utils', ['jquery'], function (r) {
        ...
        return (
          (s.GetUniqueElementId = function (e) {
            ...
            return (
              null != t ||
                ((t = e.id ? 'select2-data-' + e.id : 'select2-data-' + (++n).toString() + '-' + s.generateChars(4)), e.setAttribute('data-select2-id', t)),
              t
            );
          }),
          ...
          (s.prototype.bind = function (t, e) {
            ...
            this.$results.attr('id', n),
              ...
              t.on('results:select', function () {
                ...
                0 !== t.length &&
                  ((e = p.GetData(t[0], 'data')), t.hasClass('select2-results__option--selected') ? i.trigger('close', {}) : i.trigger('select', { data: e }));
              }),
          ...
          (e.prototype.update = function (e, t) {
            ...
            e.call(this, t),
              ...
              0 < this.$selection.find('.select2-selection__placeholder').length ||
                ...
                (e = i('<button type="button" class="select2-selection__clear" tabindex="-1"><span aria-hidden="true">&times;</span></button>')).attr(
                  'title',
                  s(),
                ),
                e.attr('aria-label', s()),
        ...
        return (
          ...
          (e.prototype.tokenizer = function (e, t, n, s) {
            for (
              ...
              var l = r[o];
              -1 !== i.indexOf(l)
                ? ((l = r.substr(0, o)), null != (l = a(c.extend({}, t, { term: l }))) ? (s(l), (r = r.substr(o + 1) || ''), (o = 0)) : o++)
                : o++;
            }
            return { term: r };
          }),
      ...
      u.define('select2/core', ['jquery', './options', './utils', './keys'], function (t, i, r, s) {
        ...
        return (
          ...
          (o.prototype._generateId = function (e) {
            return (
              'select2-' +
              (null != e.attr('id') ? e.attr('id') : null != e.attr('name') ? e.attr('name') + '-' + r.generateChars(2) : r.generateChars(4)).replace(
                /(:|\.|\[|\]|,)/g,
                '',
              )
            );
